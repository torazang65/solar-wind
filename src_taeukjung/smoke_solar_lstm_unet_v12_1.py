...
from model_solar_lstm_v12 import FORECAST_STEPS
from model_solar_lstm_unet_v12_1 import SolarWindLagLSTMUNetV12_1
...
def main():
    ...
    model = SolarWindLagLSTMUNetV12_1(
        image_size=64,
