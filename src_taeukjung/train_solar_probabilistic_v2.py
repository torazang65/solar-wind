...
SPATIAL_HEIGHT = int(os.getenv("SOLAR_V2_SPATIAL_HEIGHT", "4"))
SPATIAL_WIDTH = int(os.getenv("SOLAR_V2_SPATIAL_WIDTH", "8"))
...
if __name__ == "__main__":
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_rmse < best_val_rmse:
            ...
            torch.save(
                {
                    "architecture": "SolarWindProbabilisticTransformerV2",
                    "version": 2,
    ...
    history_frame.to_csv(
        OUTPUT_DIR / "solar_probabilistic_v2_history.csv", index=False
    )
    history_frame.plot(
    ...
    plt.tight_layout()
    plt.savefig(
        OUTPUT_DIR / "solar_probabilistic_v2_learning_curve.png", dpi=140
    )
    print(
