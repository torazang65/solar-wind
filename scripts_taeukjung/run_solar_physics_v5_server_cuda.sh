...
export OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/outputs/solar_physics_v5_taeukjung}"
...
case "${ACTION}" in
  train)
    exec python src_taeukjung/train_solar_physics_v5.py
    ;;
  infer)
    exec python src_taeukjung/inference_solar_physics_v5.py
    ;;
  *)
