...
export OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/outputs/solar_cnn_v6_taeukjung}"
...
case "${ACTION}" in
  train)
    exec python src_taeukjung/train_solar_cnn_v6.py
    ;;
  infer)
    exec python src_taeukjung/inference_solar_cnn_v6.py
    ;;
  *)
