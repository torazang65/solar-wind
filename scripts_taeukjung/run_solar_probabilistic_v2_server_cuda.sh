...
export OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/outputs/solar_probabilistic_v2_taeukjung}"
...
case "${ACTION}" in
  train)
    exec python src_taeukjung/train_solar_probabilistic_v2.py
    ;;
  infer)
    exec python src_taeukjung/inference_solar_probabilistic_v2.py
    ;;
  *)
