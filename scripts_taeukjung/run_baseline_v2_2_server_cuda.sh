...
export OUTPUT_DIR="${OUTPUT_DIR:-/home/jovyan/outputs/baseline_v2_2_taeukjung}"
...
export V22_DELTA_GAIN="${V22_DELTA_GAIN:-4.0}"
export V22_TIME_MASK_PROBABILITY="${V22_TIME_MASK_PROBABILITY:-0.15}"
export V22_MODALITY_DROP_PROBABILITY="${V22_MODALITY_DROP_PROBABILITY:-0.25}"
export V22_TIMING_PRIOR_STRENGTH="${V22_TIMING_PRIOR_STRENGTH:-0.0}"
export V22_TIMING_PRIOR_SIGMA_HOURS="${V22_TIMING_PRIOR_SIGMA_HOURS:-36}"
export V22_RESIDUAL_CAP_MULTIPLIER="${V22_RESIDUAL_CAP_MULTIPLIER:-1.5}"
export V22_RESIDUAL_L2_WEIGHT="${V22_RESIDUAL_L2_WEIGHT:-0.002}"
export V22_EMA_DECAY="${V22_EMA_DECAY:-0.995}"
export V22_WARMUP_EPOCHS="${V22_WARMUP_EPOCHS:-3}"
export V22_MIN_LR="${V22_MIN_LR:-1e-6}"
export V22_WEIGHT_DECAY="${V22_WEIGHT_DECAY:-0.02}"
export V22_EARLY_STOP_PATIENCE="${V22_EARLY_STOP_PATIENCE:-15}"

python -c 'import torch; assert torch.cuda.is_available(), "CUDA is unavailable"; print(torch.cuda.get_device_name(0))'

case "${ACTION}" in
  train)
    exec python src_taeukjung/train_baseline_v2_2.py
    ;;
  infer)
    exec python src_taeukjung/inference_baseline_v2_2.py
    ;;
  diagnose)
    exec python src_taeukjung/diagnose_baseline_v2_2.py
    ;;
  *)
