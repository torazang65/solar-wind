...
case "${ACTION}" in
  ...
  train)
    ...
    export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/../dev/outputs/solar_timing_transformer_v13_local_smoke}"
    ...
    export V13_UNET_CHANNELS="${V13_UNET_CHANNELS:-8,12,16,24,32}"
    export V13_D_MODEL="${V13_D_MODEL:-64}"
    export V13_ATTENTION_HEADS="${V13_ATTENTION_HEADS:-4}"
    export V13_DECODER_LAYERS="${V13_DECODER_LAYERS:-1}"
    export V13_FEEDFORWARD_DIM="${V13_FEEDFORWARD_DIM:-128}"
    export V13_ALIGNMENT_WEIGHT="${V13_ALIGNMENT_WEIGHT:-0.01}"
    ...
    exec python src_taeukjung/train_solar_timing_transformer_v13.py
    ;;
  *)
